...
- side note: to create a react app: "npm install -g create-react-app app-name-here" (this sets up kinda everything you need to use react if not you want to create each one in your own)
