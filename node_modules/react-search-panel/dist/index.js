...
var Chip = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: styles$5.chip },
        React__default['default'].createElement("span", { className: styles$5.chipLabel }, value),
        deleteLabel && (React__default['default'].createElement("button", { onClick: onDelete, title: deleteLabel, className: styles$5.chipDeleteContainer },
            React__default['default'].createElement(FontAwesomeIcon, { icon: faTimes, className: "" + styles$5.chipClose })))));
};
...
})(exports.SearchPanelVariant || (exports.SearchPanelVariant = {}));
/**
 * SearchPanel component
 * @param props
 */
var SearchPanel = function (props) {
    var chips = props.chips, choices = props.choices, className = props.className, clearLabel = props.clearLabel, float = props.float, isLoading = props.isLoading, maximumHeight = props.maximumHeight, noChoiceItem = props.noChoiceItem, onChange = props.onChange, onClear = props.onClear, onSelectionChange = props.onSelectionChange, placeholder = props.placeholder, preSelectedChoices = props.preSelectedChoices, shadow = props.shadow, small = props.small, value = props.value, variant = props.variant, width = props.width;
    var _a = React__default['default'].useState(false), isExpanded = _a[0], setIsExpanded = _a[1];
    var _b = React__default['default'].useState(false), isFocused = _b[0], setIsFocused = _b[1];
    var _c = React__default['default'].useState([]), selectedChoices = _c[0], setSelectedChoices = _c[1];
    var resultContainerId = "ResultContainer";
    var searchField = React__default['default'].useRef(null);
    if (float && !width) {
    ...
    var isText = true;
    if (exports.SearchPanelVariant.checkbox === variant) {
        isMultiSelect = true;
    }
    if (exports.SearchPanelVariant.link !== variant) {
        isText = false;
    }
    /**
    ...
    var ChoiceItem = function (_a) {
        ...
        return (React__default['default'].createElement("div", { className: styles$4.resultItem + " " + (small ? styles$4.small : "") },
            isText && (React__default['default'].createElement("a", { href: "", className: styles$4.linkChoice, onClick: function (event) { return handleLinkPress(event, choice); } }, choice.description)),
            !isText && (React__default['default'].createElement("label", { className: styles$4.resultItemLabel },
                React__default['default'].createElement("input", { type: inputType, onChange: function (event) { return handleCheckChanged(event, choice); }, value: choice.key, checked: getIndex(choice, selectedChoices) > -1, tabIndex: 0, className: styles$4.resultItemControl }),
                choice.description))));
    };
    ...
    return (React__default['default'].createElement("div", { 
        ...
        React__default['default'].createElement("form", { className: "\n          " + className + "\n          " + styles$4.topContainer + "\n          " + (small ? styles$4.small : "") + "\n        ", ref: clickOutsideRef, onFocus: handleOnFocus, onBlur: handleOnBlur },
            React__default['default'].createElement("div", { className: "\n            " + styles$4.searchContainer + "\n            " + (isExpanded && (choices.length > 0) ? styles$4.searchContainerExpanded : "") + "\n            " + (isExpanded && shadow ? styles$4.searchContainerExpandedShadow : "") + "\n            " + (small ? styles$4.small : "") + "\n            " + (shadow ? styles$4.searchContainerShadow : "") + "\n          " },
                React__default['default'].createElement("div", { className: styles$4.flexContainer },
                    React__default['default'].createElement("div", { className: styles$4.searchIconContainer },
                        React__default['default'].createElement("span", { className: styles$4.searchIcon },
                            React__default['default'].createElement(FontAwesomeIcon, { icon: faSearch }))),
                    React__default['default'].createElement("div", { className: styles$4.inputContainer },
                        React__default['default'].createElement("div", { className: styles$4.inputFieldContainer }),
                        React__default['default'].createElement("input", { ref: searchField, className: styles$4.inputField + " " + (small ? styles$4.small : ""), type: "text", "aria-autocomplete": "both", "aria-haspopup": "false", autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", role: "combobox", spellCheck: "false", title: placeholder, "aria-label": placeholder, "aria-controls": resultContainerId, "aria-expanded": isExpanded, placeholder: placeholder, onChange: handleSearchChange, value: value })),
                    isLoading && (React__default['default'].createElement("div", { className: styles$4.spinnerContainer + " " + (small ? styles$4.small : "") },
                        React__default['default'].createElement("span", { className: styles$4.searchIcon },
                            React__default['default'].createElement(FontAwesomeIcon, { icon: faSpinner, spin: true })))),
                    onClear && value && (React__default['default'].createElement("div", { className: styles$4.clearContainer },
                        React__default['default'].createElement("button", { onClick: onClear, title: clearLabel, className: styles$4.clearButton + " " + (small ? styles$4.small : "") },
                            React__default['default'].createElement(FontAwesomeIcon, { icon: faTimes })))))),
            isExpanded && (choices.length > 0) && (React__default['default'].createElement("div", { id: resultContainerId, className: styles$4.resultContainer, style: { width: actualWidth + "px" || "", position: (width && float) ? "absolute" : "inherit" } },
                React__default['default'].createElement("div", { className: "\n                " + styles$4.resultSeperatorContainer + "\n                " + (shadow ? styles$4.resultSeperatorContainerShadow : "") + "\n              " },
                    React__default['default'].createElement("div", { className: styles$4.resultSeperator })),
                React__default['default'].createElement("fieldset", { className: "\n                " + styles$4.resultListContainer + "\n                " + (shadow ? styles$4.resultListContainerExpandedShadow : "") + "\n                " + (small ? styles$4.small : "") + "\n              ", style: { maxHeight: maximumHeight ? maximumHeight + "px" : "" } },
                    React__default['default'].createElement("ul", { className: styles$4.resultList, role: "listbox" },
                        noChoiceItem && (React__default['default'].createElement("li", { key: noChoiceItem.key, className: styles$4.resultListItem, role: "presentation" },
                            React__default['default'].createElement(ChoiceItem, { choice: noChoiceItem }))),
                        choices.map(function (choice) { return (React__default['default'].createElement("li", { key: choice.key, className: styles$4.resultListItem, role: "presentation" },
                            React__default['default'].createElement(ChoiceItem, { choice: choice }))); })))))),
        chips && (React__default['default'].createElement("div", { className: styles$4.chipContainer }, selectedChoices.map(function (choice) { return (React__default['default'].createElement(Chip, { deleteLabel: "Delete " + choice.description, onDelete: function () { return handleRemoveSelectedChoice(choice); }, key: choice.key, value: choice.description })); })))));
};
